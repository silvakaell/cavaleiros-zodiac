    ...
    pt: {
        ...
        run: {
            ...
            battle: {
                ...
                knightRevived: (name) => `⚡ ${name} caiu... mas Hades o trouxe de volta!`,
    ...
    en: {
        ...
        run: {
            ...
            battle: {
                ...
                knightRevived: (name) => `⚡ ${name} fell... but Hades brought them back!`,
